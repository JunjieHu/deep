...
def save_checkpoint(args, trainer, epoch_itr, val_loss, epoch=None, end_of_epoch=None):
...
def load_checkpoint(args, trainer, **passthrough_args):
    ...
    *passthrough_args* will be passed through to
    ...
    print(' - [JJ] checkpoint_utils - checkpoint_path', checkpoint_path)
    ...
    if (
        ...
        # print('[JJ] checkpoint_utils.py: load extra_state')
        save_checkpoint.best = extra_state["best"]

    if extra_state is not None and not reset_dataloader:
        # restore iterator from checkpoint
        print(' - [JJ] restore epoch_itr from checkpoint')
        ...
        print('[JJ] checkpoint_utils.py: reset dataloader')
        epoch_itr = trainer.get_train_iterator(
...
def load_checkpoint_to_cpu(path, arg_overrides=None):
    ...
    print(' -- checkpoint_utils.py: upgrade_state_dict')
    return state
