...
class FairseqTask(object):
    ...
    def get_batch_iterator(
        ...
        if getattr(self.args, 'use_gpu', True) or getattr(self.args, 'cpu', True):
            print('[JJ] fairseq_task.py: use_gpu, data_utils.batch_by_size')
            batch_sampler = data_utils.batch_by_size(
                indices, dataset.num_tokens, max_tokens=max_tokens,
                max_sentences=max_sentences,
                required_batch_size_multiple=required_batch_size_multiple,
                fixed_shapes=getattr(self.args, 'input_shapes', None),
    ...
    def train_step(self, sample, model, criterion, optimizer, update_num=None, ignore_grad=False):
        """
